<template>
     <section class="skills">
            ...
            <ul class="skills__list">
                <li class="skills__item"  v-for="item in skills" v-bind:key="item" :class="{'skills__item--active' : isActive}">
                    ...
                    <div class="skills__description" :class="{'skills__description--active' : isActive}">
                        <p class="skills__description-text">
                            {{item.description }}
                        </p>
                    </div>
                </li>
